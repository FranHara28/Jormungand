...
class ResNet:
    @staticmethod
    def residual_module(data, Kin, stride, chanDim, red=False,
        ...
        conv1 = Conv2D(int(Kin * 0.25), (1, 1), use_bias=False,
        ...
        conv2 = Conv2D(int(Kin * 0.25), (3, 3), strides=stride,
        ...
        conv3 = Conv2D(Kin, (1, 1), use_bias=False,
                       kernel_regularizer=l2(reg))(act3)

        # if we are to reduce the spatial size, apply a CONV layer to
        # the shortcut
        if red:
            shortcut = Conv2D(Kin, (1, 1), strides=stride,
