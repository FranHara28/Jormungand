...
from az_dataset.helpers import load_az_dataset
from az_dataset.helpers import load_mnist_dataset
from models.resnet import ResNet

ImageDataGenerator = tf.keras.preprocessing.image.ImageDataGenerator

az_dataset_path = 'a_z_handwritten_data.csv'
output_model_path = 'handwriting.model'
plot_path = 'plot.png'
...
labelNames = [_ for _ in labelNames]
